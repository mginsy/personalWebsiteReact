...
function Experience() {
    ...
    if(isMobile){
        let fontSize = windowSize.innerWidth/23;
        return (
            ...
            animate={{opacity: 1, transition: {duration: 1}}}>
                ...
                <Row style={{width:'100%', height:'30%'}}>
                    <Col className='expCol'>
                        ...
                        animate={{opacity: 1, y:0, x:0, transition: {duration: 1}}}>
                            <a href={"https://www.accenture.com/us-en"} target="_blank" rel="noreferrer"><img  src={AccLogo} style={{height:windowSize.innerHeight/5.5.toString()+'px'}} alt="AccentureLogo"/></a>
                    ...
                    <Col className='expCol'>
                        ...
                        animate={{opacity: 1, y:0, x:0, transition: {delay: .2, duration: 1}}}>
                            <a href={"https://inkedsports.co/"} target="_blank" rel="noreferrer"><img  src={InkedLogo} style={{height:windowSize.innerHeight/5.5.toString()+'px'}} alt="EdwardsLogo"/></a>
                            <h1 style={{color:'#000000', fontSize:fontSize}}>Software Engineer</h1>
                        </motion.div>
                    </Col>
                </Row>
                <Row style={{width:'100%', height:'30%'}}>
                    <Col className='expCol'>
                        ...
                        initial={{opacity: 0, y:-100, x:-100}}
                        animate={{opacity: 1, y:0, x:0, transition: {delay: .2, duration: 1}}}>
                            <a href={"https://viterbimakers.usc.edu/"} target="_blank" rel="noreferrer"><img  src={MakersLogo} style={{height:windowSize.innerHeight/5.5.toString()+'px'}} alt="MakersLogo"/></a>
                    ...
                    <Col className='expCol'>
                        ...
                        animate={{opacity: 1, y:0, x:0, transition: {delay: .4, duration: 1}}}>
                            <a href={"https://www.edwards.com/"} target="_blank" rel="noreferrer"><img  src={EdwardsLogo} style={{height:windowSize.innerHeight/5.5.toString()+'px'}} alt="EdwardsLogo"/></a>
        ...
        let fontSize = windowSize.innerWidth/45;
        return (
            <motion.div className="homeContainer"
            exit={{opacity: 0, transition: {duration: 1.6}}}
            initial={{opacity: 0}}
